...
::: {.center-shadow-content}
 ...
 _This document introduces a conceptual systems architecture for technical review and discussion, outlining the **context**, **scope**, **boundaries**, and **operational role** of AstroGit-OS for empowering observatory control, astronomical operations, and maintenance engineering teams._  
 ...
 **Complete technical drafts are available upon request. [Technical discussions](https://github.com/pablozunigac/AstroGit-OS/issues) are welcome.**_
