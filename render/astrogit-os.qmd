...
::: {.center-shadow-content}
 ...
 _This site introduces a conceptual systems architecture for technical review and discussion, outlining the **context**, **scope**, **boundaries**, and **operational role** of AstroGit-OS empowering observatory control, astronomical operations, and engineering teams._  
 
 _For a deeper technical breakdown, download the [**full PDF overview**](../en/astrogit-os-overview.pdf), check the [**current development progress**](https://github.com/users/pablozunigac/projects/2/views/1), or visit the [**AstroGit-OS**](https://github.com/pablozunigac/AstroGit-OS) repository on GitHub. Technical feedback and architecture [**discussions**](https://github.com/pablozunigac/AstroGit-OS/issues) are welcome._
