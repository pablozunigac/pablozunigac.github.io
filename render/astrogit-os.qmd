...
::: {.center-shadow-content}
 ...
 <h4 align=center>Purpose of this Overview</h4>

 _This document introduces a conceptual systems architecture for technical review and discussion, outlining the **context**, **scope**, **boundaries**, and **operational role** of AstroGit-OS for empowering observatory control, astronomical operations, and engineering teams._  
 
 _Download the [**full PDF overview**](../en/astrogit-os-overview.pdf), check the [**current development status**](../render/astrogit-os.html#project-status-roadmap), or visit the [**AstroGit-OS**](https://github.com/pablozunigac/AstroGit-OS) repository on GitHub. **Complete technical drafts are available upon request. Technical feedback and architecture [discussions](https://github.com/pablozunigac/AstroGit-OS/issues) are welcome.**_
 ...
 * **Non-Intrusive Declarative Governance**  
 Translates infrastructure maintenance into an auditable workflow through Pull Requests and human validation, operating strictly asynchronously without interfering with real-time telescope operations.
 ...
 **Last Update Status:** [**Milestone 1**](https://github.com/pablozunigac/AstroGit-OS/milestone/1) in Progress  
 **Stable Release Date:** Early Q4 2026   
 **Next Milestone:** [**Read-only demonstrator**](https://github.com/pablozunigac/AstroGit-OS/milestone/1) against a representative operational subsystem  
